...
```html
<!-- Determine browser’s support level.    richplastow.com/w4#b4  2017/08/17 -->
...
+ You should change `['b2 e12 o10 c15 f3 i6 a2 s4']` to a list of browser name-
  codes and versions which you want to support.
